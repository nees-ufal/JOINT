...
/**
 * Main class for performing several operations with ontologies and repositories
 *
...
public class RepositoryFacade {
     ...
     * @return statements the Number of inferred Statements
     */
    ...
    public void backupRepository(String filePath) {
        this.repoOper.backupRepository(filePath);
    }
